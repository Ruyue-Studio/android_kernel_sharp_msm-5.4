...
static struct sysfs_link_device link_device_table[] = {
	/* name,	type*/
	{"lcd-therm-usr",		"lcd_therm"},
	{"xo-therm-usr",		"xo_therm"},
	{"pa-therm1-usr",		"pa_therm1"},
	{"pm8350b_tz",			"pmic_therm"},
	{"battery",				"battery"},
	{"pa-therm2-usr",		"pa_therm2"},
	{"skin-msm-therm-usr",	"sm8350_therm"},
	{"conn-therm-usr",		"usb_therm"},
	{"skin-therm-usr",		"skin_therm"},
	{"smb-therm-usr",		"smb_therm"},
	{"pm-therm-usr",		"pm_therm"},
	{"camera-therm-usr",	"cam_therm"}
};
#endif /* CONFIG_BATTERY_SHARP */
