...
//#include <sharp/shaudio_sdm660.h>         /* SHMDS_HUB_3702_01 add SHMDS_HUB_3702_02 del */
#endif
...
{
    int32_t ret = SHUB_REP_RC_NO_NEED;              /* SHMDS_HUB_0402_04 add */

// SHMDS_HUB_0208_01 add S
    if(shub_vibe_notify_check(1) || shub_speaker_notify_check(1)) { /* SHMDS_HUB_0208_02 speaker check add */
        return SHUB_REP_RC_NOT_NOTIFY;              /* SHMDS_HUB_0402_04 mod */
    }
// SHMDS_HUB_0208_01 add E
    ...
    if(send) {
        ...
        shub_exif_notify_info = 0;
        shub_change_notify_val(&shub_exif_notify_cont);
        ret = SHUB_REP_RC_OK;      /* SHMDS_HUB_0402_04 add */
    }
    return ret;                    /* SHMDS_HUB_0402_04 add */
}
...
/* SHMDS_HUB_0202_01 add S */
        ...
        if(!(shub_get_already_md_flg() & 0x01) && shub_exif_notify_info == 0) {
            ...
            return ret;                         /* SHMDS_HUB_0402_04 mod */
        }
/* SHMDS_HUB_0202_01 add E */
        else {
...
/* SHMDS_HUB_0139_02 add E */
    ...
    if(!shub_connect_check()){
        DBG_EXIF_IO("shub_exif Connect Error!!\n"); /* SHMDS_HUB_0701_14 mod */
        ret = -ENODEV;
        goto out_driver;
    }
...
//  unregister_sdm660_shub_api_notifier(&shub_audio_pedometer_handler);  /* SHMDS_HUB_3702_02 del */
#endif
/* SHMDS_HUB_3702_01 add E */
