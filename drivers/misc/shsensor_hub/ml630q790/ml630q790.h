...
#define SHUB_SW_NOTIFIER_LED            /* SHMDS_HUB_1701_20 add */
...
#define SHUB_SW_USE_SMEM
//#define SHUB_SW_OIS                   /* SHMDS_HUB_0131_01 add */
#define SHUB_SW_TIME_CORRECT            /* SHMDS_HUB_3902_02 add */
//#define SHUB_SW_GYRO_OFFSET           /* SHMDS_HUB_0362_02 add */
#define SHUB_SW_IRQ_WAIT                /* SHMDS_HUB_0405_01 add */
//#define SHUB_SW_ACC_GYRO_WAKEUP       /* SHMDS_HUB_3901_01 add */
//#define SHUB_SW_POWER_RESET           /* SHMDS_HUB_0138_01 add */
...
//  #define CONFIG_ACC_LSM6DSL          /* SHMDS_HUB_0137_01 add */
...
#define SHUB_ACTIVE_ACC_GYRO              (0x00200000) /* SHMDS_HUB_3901_01 add */
...
/* SHMDS_HUB_0402_04 add S */
#define SHUB_REP_RC_OK              (0)
#define SHUB_REP_RC_NO_NEED        (-1)
#define SHUB_REP_RC_NOT_NOTIFY     (-2)
/* SHMDS_HUB_0402_04 add E */

/* SHMDS_HUB_0138_01 add S */
#ifdef SHUB_SW_POWER_RESET
#define SHUB_RESET_L        (0)
#define SHUB_RESET_H        (1)
#endif
/* SHMDS_HUB_0138_01 add E */

#define SHUB_GYRO_OFFSET_ADJ_X       0      /* SHMDS_HUB_0362_07 add */
#define SHUB_GYRO_OFFSET_ADJ_Y       0      /* SHMDS_HUB_0362_07 add */
#define SHUB_GYRO_OFFSET_ADJ_Z       0      /* SHMDS_HUB_0362_07 add */
...
void shub_dbg_timer_start(struct timespec64 *tv);
void shub_dbg_timer_end(struct timespec64 tv, unsigned int cmd);
#define SHUB_DBG_TIME_INIT      struct timespec64 shub_timeval;
...
//#define ktime_get_boottime_ts64(x) get_monotonic_boottime(x)
...
int32_t shub_get_sensors_val(int32_t type, int32_t* data);  /* SHMDS_HUB_3901_01 add */
...
/* Input Subsystem */
void shub_input_report_acc(int32_t *data, int32_t mode);        /* SHMDS_HUB_0362_04 mod */
void shub_input_report_mag(int32_t *data);
void shub_input_report_gyro(int32_t *data, int32_t mode);       /* SHMDS_HUB_0362_04 mod */
void shub_input_report_gyro_uncal(int32_t *data, int32_t mode); /* SHMDS_HUB_0362_04 mod */
...
int32_t shub_input_report_significant(int32_t *data);                   /* SHMDS_HUB_0402_04 mod */
...
int32_t shub_input_report_exif_grav_det(bool send);                     /* SHMDS_HUB_0402_04 mod */
...
int32_t shub_input_report_exif_mot_det(unsigned char det_info);         /* SHMDS_HUB_0402_04 mod */
...
int32_t shub_get_wakeup_info_acc(void);         /* SHMDS_HUB_3901_01 add */
int32_t shub_get_wakeup_info_gyro(void);        /* SHMDS_HUB_3901_01 add */
int32_t shub_get_wakeup_info_gyro_uncal(void);  /* SHMDS_HUB_3901_01 add */
...
int shub_sleep_clk_enable(void);
#endif
/* SHMDS_HUB_0135_01 add E */

/* SHMDS_HUB_0138_01 add S */
#ifdef SHUB_SW_POWER_RESET
int shub_reset_signal(int enable);
#endif
/* SHMDS_HUB_0138_01 add E*/
bool shub_probe_done_check(void);           /* SHMDS_HUB_0139_02 add */
