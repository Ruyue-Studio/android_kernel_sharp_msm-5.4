...
static struct timespec64 shub_report_ts;  /* SHMDS_HUB_0311_08 add */
...
// SHMDS_HUB_0701_01 add E
    ...
    shub_set_report_data(data); /* SHMDS_HUB_0311_08 add */
}
...
static void shub_set_sensor_poll(int32_t en)
{
    shub_init_report_data();    /* SHMDS_HUB_0311_08 add */
...
/* SHMDS_HUB_0139_02 add E */
    ...
    if(!shub_connect_check()){
        DBG_MAG_IO("shub_mag Connect Error!!\n");   /* SHMDS_HUB_0701_14 mod */
        ret = -ENODEV;
        goto out_driver;
    }
