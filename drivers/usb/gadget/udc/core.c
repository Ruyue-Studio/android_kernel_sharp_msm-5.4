...
int shusb_qxdm_ena_flag = 0;
int shusb_softupdate_mode_flag = 0;

static int __init get_shusb_qxdm_ena_flag(char *str)
{
        get_option(&str, &shusb_qxdm_ena_flag);
        return 1;
}
__setup("androidboot.qxdmflg=", get_shusb_qxdm_ena_flag);

static int __init get_shusb_softupdate_mode_flag(char *str)
{
        get_option(&str, &shusb_softupdate_mode_flag);
        return 1;
}
__setup("androidboot.softupdateflg=", get_shusb_softupdate_mode_flag); 
