...
/* [ Debug ]                                                                  */
/*============================================================================*/
//#define	PT_DEVELOP_MODE_ENABLE

/*============================================================================*/
/* [ Config ]                                                                 */
/*============================================================================*/
#ifdef	PARADE_FACTORY_MODE_ENABLE
	#define PARADE_TPIN_CHECK_ENABLE
#endif

#define	SUPPORT_GKI_BUILD
#define	MEMORY_COPY_CHECK_ENABLE

#define	PARADE_SYSFS_BINARY_FW_UPGRADE
#define	PARADE_SYSFS_CALIBRATE
#define	PARADE_USE_CLASS_IF

#define PARADE_FINGERPRINT_NOTIFY_ENABLE

#define PARADE_LPMODE_ENABLE
#define	PARADE_GLOVE_ENABLE
#define	PARADE_CTRL_FW_REPORT_RATE_ENABLE
#define	PARADE_LPWG_ENABLE
#ifdef CONFIG_SHARP_SHTERM
	#define	PARADE_SEND_SHTERM_EVENT_ENABLE
#endif
#define	PARADE_CHARGER_ARMOR_ENABLE
#define	PARADE_ASYNC_WAKE_ENABLE
#define	PARADE_GRIP_SUPPRESSION_ENABLE
#define	PARADE_CLING_REJECT_ENABLE
#define PARADE_REJECT_TU_CHATTERING_ENABLE
#define	PARADE_CTRL_FOS_ENABLE_PARAM_ENABLE
#define	PARADE_SUPPORT_DEGRADE_FLG_ENABLE
#define	PARADE_DEGRADE_CLING_MEASURES_ENABLE

/*============================================================================*/
/* [ Parameters ]                                                             */
/*============================================================================*/
#if defined( PT_DEVELOP_MODE_ENABLE )
	#if defined( PT_CORE )
		#define PT_PARAM_DEF(name, val) \
			int name = val; \
			module_param(name, int, S_IRUGO | S_IWUSR);
	#else
		#define PT_PARAM_DEF(name, val) 	extern int name;
	#endif /* PT_CORE */
#else
	#if defined( PT_CORE )
		#define PT_PARAM_DEF(name, val) 	const int name = val;
	#else
		#define PT_PARAM_DEF(name, val) 	extern const int name;
	#endif /* PT_CORE */
#endif /* PT_DEVELOP_MODE_ENABLE */

#ifdef CONFIG_DRM_PANEL
	#define PARADE_PANEL_NOTIFIER_REGISTER_RETRY_MAX				10
	#define PARADE_PANEL_NOTIFIER_REGISTER_RETRY_INTERVAL_MS		1000
#endif

#if defined(PARADE_GLOVE_ENABLE)
	#define PARADE_GLOVE_GRIP_ENABLE	1
	#define PARADE_GLOVE_GRIP_XEDG		1
#endif /* PARADE_GLOVE_ENABLE */

#if defined(PARADE_CLING_REJECT_ENABLE)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_ENABLE,						1)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_CHECK_TIME_MS,					10000)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_TOUCH_THRESH_W,				210)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_TOUCH_THRESH_Z,				140)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_GLOVE_THRESH_W,				210)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_GLOVE_THRESH_Z,				20)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_TOUCH_THRESH_TIME_MS,			400)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_REPEAT_TOUCH_THRESH_W,			200)
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_REPEAT_GLOVE_THRESH_W,			200)
	#define PARADE_PRM_CLING_REJECT_REPEAT_TOUCH_THRESH_COUNT			10
	PT_PARAM_DEF(PARADE_PRM_CLING_REJECT_REPEAT_TOUCH_THRESH_TIME_MS,	1000)
#endif /* PARADE_CLING_REJECT_ENABLE */

#if defined(PARADE_REJECT_TU_CHATTERING_ENABLE)
	PT_PARAM_DEF(PARADE_PRM_REJECT_TU_CHATTERING_ENABLE,				1)
	PT_PARAM_DEF(PARADE_PRM_REJECT_TU_CHATTERING_TU_CHECK_TIME_MS,		30)
	PT_PARAM_DEF(PARADE_PRM_REJECT_TU_CHATTERING_TU_CHECK_THRESH_XY,	20)
	PT_PARAM_DEF(PARADE_PRM_REJECT_TU_CHATTERING_TD_INHIBIT_TIME_MS,	80)
#endif /* PARADE_REJECT_TU_CHATTERING_ENABLE */

#if defined(PARADE_CTRL_FW_REPORT_RATE_ENABLE)
	#define PARADE_CTRL_FW_REPORT_RATE_NORMAL						120
	#define PARADE_CTRL_FW_REPORT_RATE_HIGH							240

	struct pt_ctrl_fw_report_rate_table {
		int report_rate;
		u16 set_value;
	};
	static const struct pt_ctrl_fw_report_rate_table pt_ctrl_fw_report_rate_table[] = {
//		{60,	0x0C},
//		{65,	0x0B},
//		{72,	0x0A},
//		{80,	0x09},
...
//		{240,	0x03},
	...
	#define PT_CTRL_FW_REPORT_RATE_TABLE_SIZE	(sizeof(pt_ctrl_fw_report_rate_table)/sizeof(struct pt_ctrl_fw_report_rate_table))
#endif /* PARADE_CTRL_FW_REPORT_RATE_ENABLE */

#if defined(PARADE_FINGERPRINT_NOTIFY_ENABLE)
	#define PARADE_FINGERPRINT_NOTIFY_SUPPRESS_TOUCHDOWN_ENABLE
	#if defined( PARADE_FINGERPRINT_NOTIFY_SUPPRESS_TOUCHDOWN_ENABLE )
		PT_PARAM_DEF(PARADE_PRM_FINGERPRINT_NOTIFY_SUPPRESS_TOUCHDOWN_ENABLE, 1);
		PT_PARAM_DEF(PARADE_PRM_FINGERPRINT_NOTIFY_SUPPRESS_TOUCHDOWN_TIME_MS, 1000);
	...
	#define PARADE_PROXIMITY_SUPPORT_ENABLE

	#if defined(PARADE_PROXIMITY_SUPPORT_ENABLE)
		#include <misc/proximity.h>
		#define PARADE_PROXIMITY_NEAR			SH_PROXIMITY_NEAR
		#define PARADE_PROXIMITY_FAR			SH_PROXIMITY_FAR
	#endif /* PARADE_PROXIMITY_SUPPORT_ENABLE */

	#define PARADE_LPWG_GESTURE_SINGLE_TAP					(1<<0)
	#define PARADE_LPWG_GESTURE_DOUBLE_TAP					(1<<1)
	#define PARADE_LPWG_GESTURE_SINGLE_FINGER_LONG_TOUCH	(1<<2)
	#define PARADE_LPWG_GESTURE_2_FINGERS_LONG_TOUCH		(1<<3)

	#define PARADE_LPWG_WAKE_LOCK_TIMEOUT_MS		2000

	PT_PARAM_DEF(PARADE_PRM_LPWG_RESUME_RESET_ENABLE,	1);
#endif /* PARADE_LPWG_ENABLE */

#if defined(PARADE_GRIP_SUPPRESSION_ENABLE)
	PT_PARAM_DEF(PARADE_PRM_GRIP_SUPPRESSION_ENABLE,	1);
	PT_PARAM_DEF(PARADE_PRM_GRIP_X_EDGE_LFT,			1);
	PT_PARAM_DEF(PARADE_PRM_GRIP_X_EDGE_RGT,			1);
	PT_PARAM_DEF(PARADE_PRM_GRIP_X_EXC_LFT,				0);
	PT_PARAM_DEF(PARADE_PRM_GRIP_X_EXC_RGT,				0);
	PT_PARAM_DEF(PARADE_PRM_GRIP_Y_EDGE_UPR,			0);
	PT_PARAM_DEF(PARADE_PRM_GRIP_Y_EDGE_LWR,			0);
	PT_PARAM_DEF(PARADE_PRM_GRIP_Y_EXC_UPR,				0);
	PT_PARAM_DEF(PARADE_PRM_GRIP_Y_EXC_LWR,				0);
	PT_PARAM_DEF(PARADE_PRM_GRIP_FIRST_EXC,				0);
	PT_PARAM_DEF(PARADE_PRM_GRIP_EXC_EDGE_ORIGIN,		0);
#endif /* PARADE_GRIP_SUPPRESSION_ENABLE */

#if defined(PARADE_CTRL_FOS_ENABLE_PARAM_ENABLE)
	PT_PARAM_DEF(PARADE_PRM_CTRL_FOS_ENABLE_PARAM_ENABLE,				1)
	PT_PARAM_DEF(PARADE_PRM_CTRL_FOS_ENABLE_PARAM_DELAY_TIME_MS,		10000)
	PT_PARAM_DEF(PARADE_PRM_CTRL_FOS_ENABLE_PARAM_RETRY_TIME_MS,		1000)
	PT_PARAM_DEF(PARADE_PRM_CTRL_FOS_ENABLE_PARAM_INITIALIZE_BASELINES_WAIT_TIME_MS,	1000)
#endif /* PARADE_CTRL_FOS_ENABLE_PARAM_ENABLE */

#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
	PT_PARAM_DEF(PARADE_PRM_SUPPORT_DEGRADE_FLG_ENABLE,					0)
	PT_PARAM_DEF(PARADE_PRM_SUPPORT_BL_INIT_FLG_ENABLE,					1)
	PT_PARAM_DEF(PARADE_PRM_SUPPORT_RNF_FLG_ENABLE,						1)
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */

#if defined(PARADE_DEGRADE_CLING_MEASURES_ENABLE)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_ENABLE,			1)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_THRESH_X_MIN,		200)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_THRESH_X_MAX,		980)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_THRESH_Y,			150)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_THRESH_WX,			200)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_THRESH_ZWX,		32)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_THRESH_MOVE_X,		20)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_TU_COUNT_MAX,		15)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOTCH_CHECK_TIME_MS,		5000)

	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_CHECK_LO_ENABLE,			1)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_CHECK_LO_TIME_MS,		3000)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_CHECK_FINGER_LO_ENABLE,		1)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_CHECK_FINGER_LO_THRESH_W,	255)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_CHECK_LO_SKIP_JOIN_FINGER_ENABLE,	1)

	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_LARGE_TD_ENABLE,			1)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_LARGE_TD_THRESH_W,		200)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_LARGE_TD_THRESH_TIME_MS,	3000)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_LARGE_TD_TU_ENABLE,		1)

	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_NOSIZE_TD_ENABLE,		0)

	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_FOS_ENABLE_PARAM_ENABLE,			1)
	PT_PARAM_DEF(PARADE_PRM_DEGRADE_CLING_MEASURES_FOS_ENABLE_PARAM_ENABLE_TIME,	1000)
...
//#define PT_INITIAL_DEBUG_LEVEL DL_DEBUG
...
#define pt_debug(dev, dlevel, format, arg...)	 \
	do { \
		...
		if (cd_tmp == NULL) {\
			dev_err(dev, "[%5d] "format, current->pid, ##arg);\
		}\
		else if (cd_tmp->debug_level >= dlevel) {\
			if (dlevel == DL_ERROR)\
				dev_err(dev, "[%5d][%02X] "format, current->pid, cd_tmp->debug_level, ##arg);\
			else\
				dev_info(dev, "[%5d][%02X] "format, current->pid, cd_tmp->debug_level, ##arg);\
		} \
	} while (0)
...
#define PT_DRV_DBG_DRM_NOTIFIER_ON           512
#define PT_DRV_DBG_DRM_NOTIFIER_OFF          513
...
#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
#define HID_PT_BL_INIT                    0xff010043
#define HID_PT_DEGDRY                     0xff010044
#define HID_PT_DEGMOIST                   0xff010045
#define HID_PT_RNF                        0xff010046
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */
...
#define GESTURE_SINGLE_FINGER_LONG_TOUCH    (2)
#define GESTURE_SINGLE_TAP                  (3)
#define GESTURE_2_FINGERS_LONG_TOUCH        (4)
#else
#ifdef EASYWAKE_TSG6
#define GESTURE_DOUBLE_TAP         (1)
...
#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
	PT_TCH_RNF,	/* RX NOT FLAT */
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */
	PT_TCH_NOISE,	/* NOISE EFFECT */
#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
	PT_TCH_BL_INIT,	/* BL_INIT */
	PT_TCH_DEGDRY,	/* DEGDRY */
	PT_TCH_DEGMOIST,	/* DEGMOIST */
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */
...
#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
	[PT_TCH_RNF] = HID_PT_RNF,
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */
	[PT_TCH_NOISE]	= HID_PT_NOISEEFFECTS,
#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
	[PT_TCH_BL_INIT] = HID_PT_BL_INIT,
	[PT_TCH_DEGDRY] = HID_PT_DEGDRY,
	[PT_TCH_DEGMOIST] = HID_PT_DEGMOIST,
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */
...
#if defined(PARADE_FINGERPRINT_NOTIFY_ENABLE)
struct pt_fingerprint_aoi_area{
	int		left;
	int		top;
	int		right;
	int		bottom;
...
#if defined(PARADE_CLING_REJECT_ENABLE)
struct pt_cling_reject_finger_info{
	int				touch_check_enable;
	unsigned long	touch_check_start_time;
	int				repeat_touch_check_enable;
	unsigned long	repeat_touch_check_time[PARADE_PRM_CLING_REJECT_REPEAT_TOUCH_THRESH_COUNT];
	int				repeat_touch_check_time_index;
};
struct pt_cling_reject_info{
	bool								is_running;
	unsigned long						resume_time;
	int									finger_info_max;
	struct pt_cling_reject_finger_info	*finger_info;
	bool								request_initialize_baselines_flg;
	struct delayed_work					initialize_baselines_delayed_work;
};
#endif /* PARADE_CLING_REJECT_ENABLE */

#if defined(PARADE_REJECT_TU_CHATTERING_ENABLE)
struct pt_reject_tu_chattering_touch_info{
	unsigned short	x;
	unsigned short	y;
	unsigned char	obj;
	unsigned char	wx;
...
struct pt_reject_tu_chattering_finger_info{
	int					check_status;
	long unsigned int	tu_time;
	unsigned long		tu_x;
	unsigned long		tu_y;
	long unsigned int	td_time;
	struct pt_reject_tu_chattering_touch_info td_finger;
};
struct pt_reject_tu_chattering_info{
	int											finger_info_max;
	struct pt_reject_tu_chattering_finger_info	*finger_info;
	struct delayed_work							timer_delayed_work;
};
#endif /* PARADE_REJECT_TU_CHATTERING_ENABLE */

#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
struct pt_mt_support_degrade_flg_info{
	bool request_touchup_initialize_baselines_flg;
	bool request_degrade_flg_initialize_baselines_flg;
	struct delayed_work degrade_flg_initialize_baselines_delayed_work;
	long unsigned int initialize_baselines_end_time_jiffies;
};
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */

#if defined(PARADE_DEGRADE_CLING_MEASURES_ENABLE)
struct pt_mt_degrade_cling_measures_notch_finger_info{
	int					check_status;
	long unsigned int	start_time;
	unsigned short		check_x;
	unsigned short		check_y;
	unsigned short		last_x;
	unsigned short		last_y;
	int					tu_count;
};
struct pt_mt_degrade_cling_measures_large_td_info{
	int					check_status;
	long unsigned int	td_time;
};
struct pt_mt_degrade_cling_measures_lo_info{
	int					check_skip;
	unsigned char		last_wx;
	unsigned char		last_wy;
};
struct pt_mt_degrade_cling_measures_info{
	bool request_degrade_cling_measures_initialize_baselines_flg;
	struct delayed_work degrade_cling_measures_initialize_baselines_delayed_work;
	int finger_info_max;
	struct pt_mt_degrade_cling_measures_notch_finger_info	*notch_finger_info;

	bool detect_lo_flg;
	bool pre_fw_lo;
	long unsigned int detect_lo_start_time_jiffies;
	bool detect_finger_lo_flg;
	long unsigned int detect_finger_lo_start_time_jiffies;
	int check_lo_skip;
	struct pt_mt_degrade_cling_measures_lo_info	*lo_info;

	struct pt_mt_degrade_cling_measures_large_td_info	*large_td_info;
};
#endif /* PARADE_DEGRADE_CLING_MEASURES_ENABLE */
...
struct pt_mt_data {
...
#if defined(PARADE_CLING_REJECT_ENABLE)
	struct mutex mt_initialize_baselines_lock;
#endif /* PARADE_CLING_REJECT_ENABLE */
	bool is_suspended;
	...
	int num_prv_rec;
	int fw_num_prv_rec;
	int pre_fw_finger_num;
	int or_min;
	int or_max;
	int t_min;
	int t_max;
#if defined(PARADE_LPWG_ENABLE)
	struct pt_mt_lpwg_info lpwg;
#endif /* PARADE_LPWG_ENABLE */
#if defined(PARADE_SUPPORT_DEGRADE_FLG_ENABLE)
	struct pt_mt_support_degrade_flg_info degrade_flg_info;
#endif /* PARADE_SUPPORT_DEGRADE_FLG_ENABLE */
#if defined(PARADE_DEGRADE_CLING_MEASURES_ENABLE)
	struct pt_mt_degrade_cling_measures_info degrade_cling_measures_info;
#endif /* PARADE_DEGRADE_CLING_MEASURES_ENABLE */
};
...
#define PT_PREALLOCATED_CMD_BUFFER 32
	...
	bool panel_notifier_register_work_flg;
	struct work_struct panel_notifier_register_work;
#endif
#if defined(PARADE_GLOVE_ENABLE)
	unsigned int glove_enable_state;
#endif /* PARADE_GLOVE_ENABLE */
#if defined(PARADE_CTRL_FW_REPORT_RATE_ENABLE)
	unsigned int fw_report_rate_req_state;
#endif /* PARADE_CTRL_FW_REPORT_RATE_ENABLE */
#if defined(PARADE_LPWG_ENABLE)
	unsigned int lpwg_req_state;
	unsigned int lpwg_cur_state;
	bool lpwg_system_suspended;
	struct mutex lpwg_wake_lock_on_mutex;
	bool lpwg_wake_lock_on;
	struct wake_lock lpwg_wake_lock;
	struct delayed_work lpwg_wake_lock_timer;
#endif /* PARADE_LPWG_ENABLE */
	...
	unsigned int charger_armor_req_state;
#endif /* PARADE_CHARGER_ARMOR_ENABLE */
#if defined(PARADE_FINGERPRINT_NOTIFY_ENABLE)
	unsigned int fingerprint_notify_req_state;
	unsigned int fingerprint_aoi_req_state;
	struct pt_fingerprint_aoi_area fingerprint_aoi_area;
#endif /* PARADE_FINGERPRINT_NOTIFY_ENABLE */
#if defined( PARADE_FINGERPRINT_NOTIFY_SUPPRESS_TOUCHDOWN_ENABLE )
	bool fingerprint_notify_suppress_touchdown_enable;
	unsigned long fingerprint_notify_suppress_touchdown_notifytime;
#endif /* PARADE_FINGERPRINT_NOTIFY_SUPPRESS_TOUCHDOWN_ENABLE */
#if defined(PARADE_ASYNC_WAKE_ENABLE)
	bool async_wake_flg;
	wait_queue_head_t async_wake_wait_q;
	struct work_struct async_wake_work;
#endif /* PARADE_ASYNC_WAKE_ENABLE */
#if defined(PARADE_CLING_REJECT_ENABLE)
	struct pt_cling_reject_info cling_reject_info;
#endif /* PARADE_CLING_REJECT_ENABLE */
#if defined(PARADE_REJECT_TU_CHATTERING_ENABLE)
	struct pt_reject_tu_chattering_info reject_tu_chattering_info;
#endif /* PARADE_REJECT_TU_CHATTERING_ENABLE */
#if defined(PARADE_CTRL_FOS_ENABLE_PARAM_ENABLE)
	int fos_enable_state;
	struct delayed_work ctrl_fos_enable_param_delayed_work;
#endif /* PARADE_CTRL_FOS_ENABLE_PARAM_ENABLE */
};
...
#if 1
static inline int pt_platform_power_lock(struct device *dev)
{
	struct pt_core_data *cd = dev_get_drvdata(dev);

	return cd->cpdata->lock_power(cd->cpdata, 1, dev);
}
static inline int pt_platform_power_unlock(struct device *dev)
{
	struct pt_core_data *cd = dev_get_drvdata(dev);

	return cd->cpdata->lock_power(cd->cpdata, 0, dev);
}
static inline int pt_platform_check_power(struct device *dev)
{
	struct pt_core_data *cd = dev_get_drvdata(dev);

	return cd->cpdata->check_power(cd->cpdata, dev);
}
#endif

#if defined(PARADE_USE_CLASS_IF)
int shtps_class_if_init(struct device *core_dev);
void shtps_class_if_exit(void);
#endif /* PARADE_USE_CLASS_IF */

#if defined(PARADE_FINGERPRINT_NOTIFY_ENABLE)
int pt_fingerprint_notify_set_enable(struct device *dev, int enable);
int pt_fingerprint_notify_test(struct device *dev, int on);
