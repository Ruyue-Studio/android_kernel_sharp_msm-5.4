...
static struct power_supply_attr power_supply_attrs[] = {
	...
	POWER_SUPPLY_ATTR(PARTNER_TYPE),
	POWER_SUPPLY_ATTR(DEPLETED_INIT),
	POWER_SUPPLY_ATTR(DEPLETED_VER),
	POWER_SUPPLY_ATTR(DEPLETED_AVE),
	POWER_SUPPLY_ATTR(DEPLETED_POS),
	POWER_SUPPLY_ATTR(DEPLETED_RESULT),
	POWER_SUPPLY_ATTR(BATT_AGE_LEVEL),
	POWER_SUPPLY_ATTR(CHARGING_CYCLE_INIT),
	POWER_SUPPLY_ATTR(CHARGING_CYCLE_CC),
	POWER_SUPPLY_ATTR(CHARGING_CYCLE_RTC),
	POWER_SUPPLY_ATTR(OFFCHG_MODE),
	POWER_SUPPLY_ATTR(CHARGER_ERROR_STATUS),
	POWER_SUPPLY_ATTR(MSOC),
	POWER_SUPPLY_ATTR(DIRECT_CHARGE_MODE),
