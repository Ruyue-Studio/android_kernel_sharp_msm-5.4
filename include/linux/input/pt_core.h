...
struct pt_core_platform_data {
	...
	struct pinctrl_state *int_state_no_pull;
	struct pinctrl_state *reset_state_active;
	struct pinctrl_state *reset_state_standby;
	int (*lock_power)(struct pt_core_platform_data *pdata,
		int on, struct device *dev);
	int (*check_power)(struct pt_core_platform_data *pdata,
		struct device *dev);
#endif
