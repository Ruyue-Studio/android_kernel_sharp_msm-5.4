...
# Fragements that are available for SHARP

SHARP_NAME=`echo ${TARGET_PRODUCT,,} | awk '{ sub("_.*$", ""); print $0;}'`
SHARP_GKI_FRAG=${CONFIGS_DIR}/${SHARP_NAME}_GKI.config
SHARP_QGKI_FRAG=${CONFIGS_DIR}/${SHARP_NAME}_QGKI.config
SHARP_DEBUG_FRAG=${CONFIGS_DIR}/${SHARP_NAME}_debug.config
#SH_BSP_CUST_Add End
