...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00033 */
enum msm_drive_mode {
	MSM_DISPLAY_DRIVE_MODE_DISP_OFF = 0,
	MSM_DISPLAY_DRIVE_MODE_NORMAL,
	MSM_DISPLAY_DRIVE_MODE_GAME,
	MSM_DISPLAY_DRIVE_MODE_SUPER_BRIGHT,
	MSM_DISPLAY_DRIVE_MODE_GRADATION_12BIT,
	MSM_DISPLAY_DRIVE_MODE_HIGH_BRIGHTNESS,
};
#endif /* CONFIG_SHARP_DISPLAY */
