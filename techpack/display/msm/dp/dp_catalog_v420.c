...
static u8 vm_pre_emphasis[MAX_VOLTAGE_LEVELS * MAX_PRE_EMP_LEVELS] = {
...
static u8 vm_voltage_swing[MAX_VOLTAGE_LEVELS * MAX_PRE_EMP_LEVELS] = {
...
static u8 dp_pre_emp_hbr2_hbr3[MAX_VOLTAGE_LEVELS * MAX_PRE_EMP_LEVELS] = {
	0x11, 0x0C, 0x15, 0x1B, /* pe0, 0 db */
	0x02, 0x0F, 0x14, 0xFF, /* pe1, 3.5 db */
	0x11, 0x13, 0xFF, 0xFF, /* pe2, 6.0 db */
	0x04, 0xFF, 0xFF, 0xFF  /* pe3, 9.5 db */
};

static u8 dp_swing_hbr2_hbr3[MAX_VOLTAGE_LEVELS * MAX_PRE_EMP_LEVELS] = {
	0x1F, 0x12, 0x16, 0x1A, /* sw0, 0.4v  */
	0x09, 0x19, 0x1F, 0xFF, /* sw1, 0.6v */
	0x1F, 0x1F, 0xFF, 0xFF, /* sw1, 0.8v */
	0x1F, 0xFF, 0xFF, 0xFF  /* sw1, 1.2v */
};

static u8 dp_pre_emp_hbr_rbr[MAX_VOLTAGE_LEVELS * MAX_PRE_EMP_LEVELS] = {
	0x00, 0x0B, 0x15, 0x1C, /* pe0, 0 db */
	0x02, 0x10, 0x17, 0xFF, /* pe1, 3.5 db */
	0x05, 0x0F, 0xFF, 0xFF, /* pe2, 6.0 db */
	0x01, 0xFF, 0xFF, 0xFF  /* pe3, 9.5 db */
};

static u8 dp_swing_hbr_rbr[MAX_VOLTAGE_LEVELS * MAX_PRE_EMP_LEVELS] = {
...
module_param_array(vm_pre_emphasis, byte, NULL, 0644);
module_param_array(vm_voltage_swing, byte, NULL, 0644);
module_param_array(dp_pre_emp_hbr2_hbr3, byte, NULL, 0644);
module_param_array(dp_swing_hbr2_hbr3, byte, NULL, 0644);
module_param_array(dp_pre_emp_hbr_rbr, byte, NULL, 0644);
module_param_array(dp_swing_hbr_rbr, byte, NULL, 0644);
#else
		...
		u8 v_level, u8 p_level, bool high)
{
	...
	if (version >= 0x10020003) {
		if (high) {
			value0 = dp_swing_hbr2_hbr3[v_level * MAX_PRE_EMP_LEVELS + p_level];
			value1 = dp_pre_emp_hbr2_hbr3[v_level * MAX_PRE_EMP_LEVELS + p_level];
		} else {
			value0 = dp_swing_hbr_rbr[v_level * MAX_PRE_EMP_LEVELS + p_level];
			value1 = dp_pre_emp_hbr_rbr[v_level * MAX_PRE_EMP_LEVELS + p_level];
		}
	} else {
		value0 = vm_voltage_swing[v_level * MAX_PRE_EMP_LEVELS + p_level];
		value1 = vm_pre_emphasis[v_level * MAX_PRE_EMP_LEVELS + p_level];
	}
#else
	/*
	 * For DP controller versions >= 1.2.3
