...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00056 */
	pr_debug("%s: set_wake_lock", __func__);
	drm_cmn_set_wakelock(&dp->wakelock, true);
#endif /* CONFIG_SHARP_DISPLAY */
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00056 */
	pr_debug("%s: release_wake_lock", __func__);
	drm_cmn_set_wakelock(&dp->wakelock, false);
#endif /* CONFIG_SHARP_DISPLAY */
...
{
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00056 */
	drm_cmn_wake_lock_destroy(&dp->wakelock);
#endif /* CONFIG_SHARP_DISPLAY */
...
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00056 */
	drm_cmn_wake_lock_init(&dp->wakelock, dev, "dp_wakelock");
#endif /* CONFIG_SHARP_DISPLAY */
