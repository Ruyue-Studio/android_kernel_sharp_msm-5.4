...
/* DEFINE                                                                    */
/* ------------------------------------------------------------------------- */
#ifdef CONFIG_ARCH_JUDAU
#define DRM_LCDDR_BUF_MAX       (255)
#define USES_PANEL_OLAF
#elif CONFIG_ARCH_BANAGHER
#define USES_PANEL_RAVEN
#define DRM_FPS_LED_PANEL_SUPPORT
#define DRM_LCDDR_BUF_MAX       (127)
#else /* CONFIG_ARCH_other */
#define USES_PANEL_STEIN
#define DRM_LCDDR_BUF_MAX       (15)
#endif /* CONFIG_ARCH_JUDAU */
...
static unsigned char rw_buf[DRM_LCDDR_BUF_MAX] = {0};
...
#elif defined(USES_PANEL_OLAF)
static int drm_proc_mfr_olaf(struct dsi_display *display, int value);
#else /* USES_PANEL_xxx */
...
static int drm_proc_read_cases(struct drm_procfs *drm_pfs, struct dsi_display *dsi_display)
{
	...
	memset(rw_buf, 0x00, sizeof(rw_buf));
	dsi_req.data = rw_buf;
...
static int drm_panel_dsi_write_reg(struct drm_dsi_cmd_req *req)
{
	...
	static char cmd_buf[DRM_LCDDR_BUF_MAX + 1];
...
#elif defined(USES_PANEL_OLAF)
	ret = drm_proc_mfr_olaf(display, value);
#else  /* USES_PANEL_XXX */
...
static int drm_proc_mfr_elsa(struct dsi_display *display, int value)
{
	...
	static struct dsi_cmd_desc mfr_cmd[] = {
		...
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[4], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
		...
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[16], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
		...
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[21], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[22], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[23], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[24], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[25], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[26], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[27], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[28], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[29], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[30], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[31], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[32], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[33], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[34], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[35], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[36], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[37], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[38], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[39], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[40], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[41], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[42], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[43], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[44], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[45], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[46], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[47], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[48], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[49], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[50], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[51], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[52], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[53], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[54], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[55], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[56], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[57], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[58], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[59], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[60], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[61], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[62], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[63], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[64], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[65], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[66], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[67], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[68], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[69], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[70], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[71], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[72], 0, 0}, 1, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[73], 0, 0}, 1, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0,  2, mfr_proc_cmd_addr_value[74], 0, 0}, 1, 0},
	};

	switch(value) {
	case 120:
		mfr_proc_cmd_addr_value[ 0][1] = 0xD2;
		mfr_proc_cmd_addr_value[ 1][1] = 0x97;
		mfr_proc_cmd_addr_value[ 2][1] = 0xD0;
		mfr_proc_cmd_addr_value[ 3][1] = 0x01;
		mfr_proc_cmd_addr_value[ 4][1] = 0xAA;
		mfr_proc_cmd_addr_value[ 5][1] = 0x40;
		mfr_proc_cmd_addr_value[ 6][1] = 0x30;
		mfr_proc_cmd_addr_value[ 7][1] = 0x00;
		mfr_proc_cmd_addr_value[ 8][1] = 0x60;
		mfr_proc_cmd_addr_value[ 9][1] = 0x06;
		mfr_proc_cmd_addr_value[10][1] = 0x06;
		mfr_proc_cmd_addr_value[11][1] = 0xC8;
		mfr_proc_cmd_addr_value[12][1] = 0x04;
		mfr_proc_cmd_addr_value[13][1] = 0x00;
		mfr_proc_cmd_addr_value[14][1] = 0xC8;
		mfr_proc_cmd_addr_value[15][1] = 0x05;
		mfr_proc_cmd_addr_value[16][1] = 0x00;
		mfr_proc_cmd_addr_value[17][1] = 0x00;
		mfr_proc_cmd_addr_value[18][1] = 0xF3;
		mfr_proc_cmd_addr_value[19][1] = 0xD0;
		mfr_proc_cmd_addr_value[20][1] = 0x85;
		mfr_proc_cmd_addr_value[21][1] = 0x0E;
		mfr_proc_cmd_addr_value[22][1] = 0x72;
		mfr_proc_cmd_addr_value[23][1] = 0x00;
		mfr_proc_cmd_addr_value[24][1] = 0x15;
		mfr_proc_cmd_addr_value[25][1] = 0x00;
		mfr_proc_cmd_addr_value[26][1] = 0x2A;
		mfr_proc_cmd_addr_value[27][1] = 0x00;
		mfr_proc_cmd_addr_value[28][1] = 0x54;
		mfr_proc_cmd_addr_value[29][1] = 0x00;
		mfr_proc_cmd_addr_value[30][1] = 0x7E;
		mfr_proc_cmd_addr_value[31][1] = 0x00;
		mfr_proc_cmd_addr_value[32][1] = 0xAA;
		mfr_proc_cmd_addr_value[33][1] = 0x00;
		mfr_proc_cmd_addr_value[34][1] = 0xE6;
		mfr_proc_cmd_addr_value[35][1] = 0x01;
		mfr_proc_cmd_addr_value[36][1] = 0x36;
		mfr_proc_cmd_addr_value[37][1] = 0x01;
		mfr_proc_cmd_addr_value[38][1] = 0xA8;
		mfr_proc_cmd_addr_value[39][1] = 0x02;
		mfr_proc_cmd_addr_value[40][1] = 0x3D;
		mfr_proc_cmd_addr_value[41][1] = 0x02;
		mfr_proc_cmd_addr_value[42][1] = 0xFA;
		mfr_proc_cmd_addr_value[43][1] = 0x03;
		mfr_proc_cmd_addr_value[44][1] = 0x8C;
		mfr_proc_cmd_addr_value[45][1] = 0x00;
		mfr_proc_cmd_addr_value[46][1] = 0x00;
		mfr_proc_cmd_addr_value[47][1] = 0x00;
		mfr_proc_cmd_addr_value[48][1] = 0x00;
		mfr_proc_cmd_addr_value[49][1] = 0x00;
		mfr_proc_cmd_addr_value[50][1] = 0x00;
		mfr_proc_cmd_addr_value[51][1] = 0x00;
		mfr_proc_cmd_addr_value[52][1] = 0x00;
		mfr_proc_cmd_addr_value[53][1] = 0x00;
		mfr_proc_cmd_addr_value[54][1] = 0x00;
		mfr_proc_cmd_addr_value[55][1] = 0x00;
		mfr_proc_cmd_addr_value[56][1] = 0x00;
		mfr_proc_cmd_addr_value[57][1] = 0x00;
		mfr_proc_cmd_addr_value[58][1] = 0x03;
		mfr_proc_cmd_addr_value[59][1] = 0x00;
		mfr_proc_cmd_addr_value[60][1] = 0x0A;
		mfr_proc_cmd_addr_value[61][1] = 0x00;
		mfr_proc_cmd_addr_value[62][1] = 0x30;
		mfr_proc_cmd_addr_value[63][1] = 0x01;
		mfr_proc_cmd_addr_value[64][1] = 0x89;
		mfr_proc_cmd_addr_value[65][1] = 0x02;
		mfr_proc_cmd_addr_value[66][1] = 0x9A;
		mfr_proc_cmd_addr_value[67][1] = 0x9C;
		mfr_proc_cmd_addr_value[68][1] = 0xAA;
		mfr_proc_cmd_addr_value[69][1] = 0xD2;
		mfr_proc_cmd_addr_value[70][1] = 0x9F;
		mfr_proc_cmd_addr_value[71][1] = 0xD0;
		mfr_proc_cmd_addr_value[72][1] = 0x02;
		mfr_proc_cmd_addr_value[73][1] = 0xAA;
		mfr_proc_cmd_addr_value[74][1] = 0x00;
		break;
	case 60:
		mfr_proc_cmd_addr_value[ 0][1] = 0xD2;
		mfr_proc_cmd_addr_value[ 1][1] = 0x97;
		...
		mfr_proc_cmd_addr_value[ 4][1] = 0xAA;
		mfr_proc_cmd_addr_value[ 5][1] = 0x40;
		mfr_proc_cmd_addr_value[ 6][1] = 0x31;
		mfr_proc_cmd_addr_value[ 7][1] = 0x41;
		mfr_proc_cmd_addr_value[ 8][1] = 0x60;
		mfr_proc_cmd_addr_value[ 9][1] = 0x04;
		mfr_proc_cmd_addr_value[10][1] = 0x04;
		mfr_proc_cmd_addr_value[11][1] = 0xC0;
		mfr_proc_cmd_addr_value[12][1] = 0x06;
		mfr_proc_cmd_addr_value[13][1] = 0x08;
		mfr_proc_cmd_addr_value[14][1] = 0xC0;
		mfr_proc_cmd_addr_value[15][1] = 0x07;
		mfr_proc_cmd_addr_value[16][1] = 0x0A;
		mfr_proc_cmd_addr_value[17][1] = 0x06;
		mfr_proc_cmd_addr_value[18][1] = 0xF3;
		mfr_proc_cmd_addr_value[19][1] = 0xD0;
		mfr_proc_cmd_addr_value[20][1] = 0x81;
		mfr_proc_cmd_addr_value[21][1] = 0x0E;
		mfr_proc_cmd_addr_value[22][1] = 0x72;
		mfr_proc_cmd_addr_value[23][1] = 0x00;
		mfr_proc_cmd_addr_value[24][1] = 0x15;
		...
		mfr_proc_cmd_addr_value[34][1] = 0xE6;
		mfr_proc_cmd_addr_value[35][1] = 0x01;
		mfr_proc_cmd_addr_value[36][1] = 0x1C;
		mfr_proc_cmd_addr_value[37][1] = 0x01;
		mfr_proc_cmd_addr_value[38][1] = 0x8C;
		mfr_proc_cmd_addr_value[39][1] = 0x02;
		mfr_proc_cmd_addr_value[40][1] = 0x20;
		mfr_proc_cmd_addr_value[41][1] = 0x02;
		mfr_proc_cmd_addr_value[42][1] = 0xEA;
		mfr_proc_cmd_addr_value[43][1] = 0x03;
		mfr_proc_cmd_addr_value[44][1] = 0x8D;
		mfr_proc_cmd_addr_value[45][1] = 0x00;
		mfr_proc_cmd_addr_value[46][1] = 0x00;
		mfr_proc_cmd_addr_value[47][1] = 0x00;
		mfr_proc_cmd_addr_value[48][1] = 0x00;
		...
		mfr_proc_cmd_addr_value[50][1] = 0x00;
		mfr_proc_cmd_addr_value[51][1] = 0x00;
		mfr_proc_cmd_addr_value[52][1] = 0x07;
		mfr_proc_cmd_addr_value[53][1] = 0x00;
		mfr_proc_cmd_addr_value[54][1] = 0x0E;
		mfr_proc_cmd_addr_value[55][1] = 0x00;
		mfr_proc_cmd_addr_value[56][1] = 0x1D;
		mfr_proc_cmd_addr_value[57][1] = 0x00;
		mfr_proc_cmd_addr_value[58][1] = 0x37;
		mfr_proc_cmd_addr_value[59][1] = 0x00;
		mfr_proc_cmd_addr_value[60][1] = 0x7F;
		mfr_proc_cmd_addr_value[61][1] = 0x00;
		mfr_proc_cmd_addr_value[62][1] = 0xFA;
		mfr_proc_cmd_addr_value[63][1] = 0x01;
		mfr_proc_cmd_addr_value[64][1] = 0xEE;
		mfr_proc_cmd_addr_value[65][1] = 0x02;
		mfr_proc_cmd_addr_value[66][1] = 0xEA;
		mfr_proc_cmd_addr_value[67][1] = 0x10;
		mfr_proc_cmd_addr_value[68][1] = 0xAA;
		mfr_proc_cmd_addr_value[69][1] = 0xD2;
		mfr_proc_cmd_addr_value[70][1] = 0x9F;
		mfr_proc_cmd_addr_value[71][1] = 0xD0;
	...
	mfr_proc_cmd_addr_value[3][1] = mfr;
...
static int drm_proc_mfr_olaf(struct dsi_display *display, int value)
{
	...
	static unsigned char mfr_proc_cmd_addr_value[][6] = {
		{0xF0, 0x55,
		       0xAA,
		       0x52,
		       0x08,
	...
	static struct dsi_cmd_desc mfr_cmd[] = {
		{{0, MIPI_DSI_DCS_LONG_WRITE, MIPI_DSI_MSG_USE_LPM,
			0, 0, 6, mfr_proc_cmd_addr_value[0], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0, 2, mfr_proc_cmd_addr_value[1], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0, 2, mfr_proc_cmd_addr_value[2], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_LONG_WRITE, MIPI_DSI_MSG_USE_LPM,
			0, 0, 5, mfr_proc_cmd_addr_value[3], 0, 0}, 1, 0},
	};
	static struct dsi_cmd_desc mfr_cmd_120[] = {
		{{0, MIPI_DSI_DCS_LONG_WRITE, MIPI_DSI_MSG_USE_LPM,
			0, 0, 6, mfr_proc_cmd_addr_value[0], 0, 0}, 0, 0},
		{{0, MIPI_DSI_DCS_SHORT_WRITE_PARAM, MIPI_DSI_MSG_USE_LPM,
			0, 0, 2, mfr_proc_cmd_addr_value[1], 0, 0}, 1, 0},
	};

	switch(value) {
	case 120:
		mfr_proc_cmd_addr_value[1][1] = 0x01;
		break;
	case 60:
		mfr_proc_cmd_addr_value[1][1] = 0x00;
		mfr_proc_cmd_addr_value[3][3] = 0x01;
		mfr_proc_cmd_addr_value[3][4] = 0x01;
		break;
	case 30:
		mfr_proc_cmd_addr_value[1][1] = 0x00;
		mfr_proc_cmd_addr_value[3][3] = 0x03;
		mfr_proc_cmd_addr_value[3][4] = 0x03;
		break;
	case 1:
		mfr_proc_cmd_addr_value[1][1] = 0x00;
		mfr_proc_cmd_addr_value[3][3] = 0x03;
		mfr_proc_cmd_addr_value[3][4] = 0x77;
		break;
	default:
		pr_err("%s:error.not support mfr=%d\n", __func__, value);
		return -EPERM;
	...
	if (value == 120) {
		cmd_cnt = ARRAY_SIZE(mfr_cmd_120);
		cmds = mfr_cmd_120;
	} else {
		cmd_cnt = ARRAY_SIZE(mfr_cmd);
		cmds = mfr_cmd;
