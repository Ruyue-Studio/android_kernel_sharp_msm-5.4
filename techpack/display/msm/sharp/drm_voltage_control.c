...
{
	int ret = 0;
	unsigned char addr_value_page[] = {0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00};
	...
	struct dsi_cmd_desc cmd[] = {
		{{0, MIPI_DSI_GENERIC_LONG_WRITE	, MIPI_DSI_MSG_USE_LPM | MIPI_DSI_MSG_UNICAST, 0, 0,
				sizeof(addr_value_page), addr_value_page, 0, NULL}, 0, 0},
		{{0, MIPI_DSI_GENERIC_LONG_WRITE	, MIPI_DSI_MSG_USE_LPM | MIPI_DSI_MSG_UNICAST, 0, 0,
				sizeof(addr_value[0]), addr_value[0], 0, NULL}, 0, 0},
		{{0, MIPI_DSI_GENERIC_LONG_WRITE	, MIPI_DSI_MSG_USE_LPM | MIPI_DSI_MSG_UNICAST, 0, 0,
				sizeof(addr_value[1]), addr_value[1], 0, NULL}, 1, 0},
	};
