...
struct sde_connector_ops {
	...
	int (*set_drive_mode)(void *display, enum msm_drive_mode mode);
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00042 */
	void (*voltage_control_enable)(bool en);
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00036 */
	void (*bias_enable)(bool en);
#endif /* CONFIG_SHARP_DISPLAY */
#ifdef CONFIG_SHARP_DISPLAY /* CUST_ID_00049 */
	void (*peak_brightness_ctrl_enable)(bool en);
#endif /* CONFIG_SHARP_DISPLAY */
