...
_Bool cs35l41_readable_reg(struct device *dev, u32 reg);
_Bool cs35l41_precious_reg(struct device *dev, u32 reg);
_Bool cs35l41_volatile_reg(struct device *dev, u32 reg);
...
struct cs35l41_classh_cfg {
	_Bool classh_bst_override;
	_Bool classh_algo_enable;
	s32 classh_bst_max_limit;
	s32 classh_mem_depth;
	s32 classh_release_rate;
	s32 classh_headroom;
	s32 classh_wk_fet_delay;
	s32 classh_wk_fet_thld;
};
...
struct cs35l41_platform_data {
	...
	_Bool dsp_ng_enable;
	_Bool invert_pcm;
	_Bool hibernate_enable;
	_Bool fwname_use_revid;
...
struct cs35l41_vol_ctl {
	...
	atomic_t manual_ramp; /* _Boolean */
	atomic_t ramp_abort; /* _Boolean */
	atomic_t vol_ramp; /* _Boolean */
	atomic_t playback; /* _Boolean */
	s32 ramp_init_att;
	s32 ramp_knee_att;
	u32 ramp_knee_time;
	u32 ramp_end_time;
	s32 dig_vol;
	u32 auto_ramp_timeout;
	u32 output_dev;
	u32 prev_active_dev;
...
struct cs35l41_private {
	...
	_Bool swire_mode;
	_Bool halo_booted;
	_Bool skip_codec_probe;
	_Bool bus_spi;
	_Bool fast_switch_en;
	_Bool force_int;
	_Bool hibernate_force_wake;
	/* GPIO for /RST */
	struct gpio_desc *reset_gpio;
	/* Run-time mixer */
	u32 fast_switch_file_idx;
	...
	u32 ctl_cache[CS35L41_CTRL_CACHE_SIZE];
	u32 trim_cache[CS35L41_TRIM_CACHE_SIZE];
	const char *dt_name;
};

s32 cs35l41_probe(struct cs35l41_private *cs35l41,
				struct cs35l41_platform_data *pdata);
s32 cs35l41_remove(struct cs35l41_private *cs35l41);
